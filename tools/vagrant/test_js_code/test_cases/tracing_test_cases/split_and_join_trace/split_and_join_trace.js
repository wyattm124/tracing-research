...
const tracer = new Tracer({
  ...
  localServiceName: 'Split and Join Trace' // name of this application
});
...
console.log('Starting : Split and Join Trace ...');


// To avoid asynch, we block for the result
tracer.setId(tracer.createRootId());
tracer.recordServiceName("Split and Join Trace")
...
// NOTE : Due to the inheritance problem from join, this is not finished
